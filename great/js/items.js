...
$(document).ready(function () {
  ...
  $('#item-1-playlist').click(function () {
    $('#item-1-playlist').removeClass("old-selected");
    $('#item-1-playlist').children(".item-arrow-grey").hide();
    $('#item-1-playlist').siblings().removeClass("old-selected");
    $('#item-1-playlist').siblings().children(".item-arrow-grey").hide();
    $('.folder-playlist').show();
    $('.folder-playlist').siblings().hide();
    $('.folder-playlist').children().removeClass("selected");
    $('.folder-playlist').children().removeClass("old-selected");
    $('.folder-playlist').children().children(".item-arrow-grey").hide();
    $('.folder-playlist').children().children(".item-arrow-blue").hide();
    $('.folder-playlist').children().children(".item-arrow").show();
  });
  ...
  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.youtube.com/c/hvher');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.gg/asjGCX75D8');
  });


  $('#item-2-spotify').dblclick(function () {
    window.open('spotify:user:9hjt7018bxpbi40yro11dnzjl:playlist:2RUwiX9KygUbTFErS2X53v');
  });
